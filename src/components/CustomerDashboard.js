...
export default function CustomerDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-4xl font-bold text-center mb-8 text-gray-800">Customer Dashboard</h2>
      <hr className="mb-8"/>

      <section className="mb-10 mt-4">
        <h3 className="text-3xl font-semibold mb-6 text-center text-gray-700">Account Details</h3>
